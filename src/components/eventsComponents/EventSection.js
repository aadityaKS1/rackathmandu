...
const Images = { health, tree, anniversary, workshop, supply, hiking };
...
const eventData = [
  {
    ...
    description: "Free medical checkups and health awareness program for underserved communities.",
    status: "Completed",
    actionType: "view",
  },
  {
    ...
    description: "Join us in planting 500 trees to combat deforestation.",
    status: "Upcoming",
    actionType: "join",
  },
  {
    ...
    description: "Celebration of our club’s anniversary with dinner and awards.",
    status: "Completed",
    actionType: "view",
  },
  {
    ...
    description: "Professional skills workshop focusing on resume building and interviews.",
    status: "Upcoming",
    actionType: "join",
  },
  {
    ...
    description: "Collection and distribution of school supplies to children.",
    status: "Completed",
    actionType: "view",
  },
  {
    ...
    description: "A day of adventure and team building with fellow Rotaractors.",
    status: "Upcoming",
    actionType: "join",
  },
];
...
const EventSection = () => {
  ...
  const filteredEvents =
    activeFilter === "All"
      ? eventData
      : eventData.filter(event => event.status === activeFilter);
